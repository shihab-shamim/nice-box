...
const OneCard = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onClick: () => {
      if (!options.isIcon && !RichTextComponent && options?.clickOnCard) {
  ...
  }, options?.isTitle && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", {
    className: "nbhs-card-title",
    dangerouslySetInnerHTML: {
      __html: card.title
    }
  }), options?.isTitle && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    className: "nbhs-card-title",
    placeholder: "Enter Title",
    tagName: "h5",
    val: card.title,
    onChange: v => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(cards, v, index, "title")
    })
  }), options?.isDivider && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", {
    className: "nbhs-card-divider"
  }), options?.isDescription && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "nbhs-card-text",
    dangerouslySetInnerHTML: {
      __html: card.description
    }
  }), options?.isDescription && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    className: "nbhs-card-text",
    tagName: "p",
    placeholder: "Enter description",
    val: card.description,
    onChange: v => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(cards, v, index, "description")
    })
